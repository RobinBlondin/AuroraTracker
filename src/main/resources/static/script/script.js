...
const unSubscribeOnLocation = async () => {
  ...
  if (response.ok) {
    ...
    const removed = document.getElementById("map");
    removed.style.backgroundImage = "url('images/startpageformap.png')";
    removed.style.backgroundPosition = "center";
    removed.style.backgroundSize = "cover";
    removed.style.backgroundRepeat = "no-repeat";
  }
};
